...
import LandingPage from "./pages/shop/LandingPageInicio";
import CategoryPage from "./pages/shop/PaginaCategorias";
import ProductsPage from "./pages/shop/PaginaArticulos";
import CartPage from "./pages/shop/PaginaCarrito";
import WishlistPage from "./pages/shop/PaginaWishlist";
import ProductDetailPage from "./pages/shop/ProductDetailPage";
import SocialFeedPage from "./pages/social/PaginaPrincipalSocial";
import SavedLooksPage from "./pages/social/PaginaLooksGuardados";
import AuthPage from "./pages/shop/AuthPage";
import UserProfilePage from "./pages/social/PaginaPerfilUsuario";
import NewsPage from "./pages/social/PaginaNoticiasAPI";
